        ...
        {whatIDo.map((item, index) => {
          ...
          return (
            <motion.div
              ...
              className="flex items-start gap-4 p-4 border border-primary/30 rounded-lg shadow-sm duration-200 ease-out hover:translate-x-1 hover:shadow-md transition-all"
            >
